    ...
    const blogs = [
        {
            ...
            userImage: '/Images/Blogs/BlogContent/shlok.webp',
        ...
        <>
            <div className="BlogsContainer">
                <div className="BlogsContainer__background">
                    <img className="BlogsContainer__background--image" src="/Images/Blogs/blogs_bg.webp" />
                </div>
                <div className='BlogsContainer__title'>
                    <img className='BlogsContainer__title--image' src='/Images/Blogs/surge_white.webp' />
